...
export default function SectionProducts(){
    return(
            <article className="flex flex-col lg:grid lg:grid-flow-col lg:grid-rows-1">
                ...
                <div className="flex flex-col items-center flex-wrap gap-4 p-8 lg:col-start-1 lg:flex-row lg:col-end-3 ">
                    ...
                    <img src="/img/products/PlayStation-desk.webp" alt="" className="hidden lg:block lg:relative lg:right-57"/>
                        ...
                        <p className="font-inter font-medium text-[#909090] text-center lg:float-left">Incredibly powerful CPUs, GPUs, and an SSD with integrated I/O will redefine your PlayStation experience.</p>
                ...
                <div className="flex flex-col items-center flex-wrap bg-[#EDEDED] gap-4 p-8 lg:row-span-2 lg:flex-row-reverse">
                    ...
                    <div className="lg:flex lg:flex-col lg:justify-start lg:flex-wrap lg:items-center lg:relative right ">
